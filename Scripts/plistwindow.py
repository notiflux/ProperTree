...
<dict>"""
        ...
        style.configure("BW.Treeview", foreground="white", background="gray10")
        style.configure("BW.Treeview.Heading", background="gray10", foreground="white", relief="flat")
        style.layout("BW.Treeview", [('BWTreeview.treearea', {'sticky': 'nswe'})])
        self._tree_frame = ttk.Frame(self, style="BW.Treeview.Heading")
        ...
        vsb = tk.Scrollbar(self._tree_frame, orient='vertical', command=self._tree.yview, bg="gray20", troughcolor="gray10")
    ...
    def alternate_colors(self, event = None):
        ...
        self._tree.tag_configure('odd', background="gray10")
        #self._tree.tag_configure('even', background='#DFDFDF')
        self._tree.tag_configure('even', background="#222222")
